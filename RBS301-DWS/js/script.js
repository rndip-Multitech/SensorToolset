document.addEventListener("DOMContentLoaded", () => {
    ...
    const aboutDwsBtn = document.getElementById("about-dws-button");
    ...
    /* ============================================================
       About Door-Window Settings
    ============================================================ */
    aboutDwsBtn.addEventListener("click", () => {
        showDialog(
            "You can choose to be notified any time the door or window is opened or closed.\n\n" +
            ...
            "a state-change message is sent immediately whenever the door/window toggles."
        );
    });
    ...
    generateButton.addEventListener("click", () => {
        ...
        if (!cClose && !cOpen) {
            showDialog(
                ...
                "- Send Notification on Door/Window Close\n" +
                "- Send Notification on Door/Window Open"
            );
            return;
        }
    ...
    if (scheduleButton) {
        scheduleButton.addEventListener("click", () => {
            ...
            const sensorType = "door/window sensor";
